...
class ComputeLoss:
    ...
    def __call__(self, p, targets):  # predictions, targets, model
        ...
        ldepth = torch.zeros(1, device=device)  # 深度损失
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            if n:
                ...
                # depth
                ldepth += torch.nn.MSELoss(ps[:, 6], tdepth[i])
    ...
    def build_targets(self, p, targets):
        ...
        # targets的值[ [[image,class,x,y,w,h,0],  ---depth
        #             [image,class,x,y,w,h,0],  ---depth
        #               	...		共nt个   ]

        # 			  [[image,class,x,y,w,h,1]，  ---depth
        #              [image,class,x,y,w,h,1],  ---depth
        #                   ...		共nt个    ]

        # 			  [[image,class,x,y,w,h,2]，  ---depth
        #              [image,class,x,y,w,h,2],  ---depth
        #                   ...		共nt个    ]
        #          ]
